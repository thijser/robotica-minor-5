...
\chapter{Use Cases}
In this chapter, the use cases will be explained. The use cases can be found in Appendix A. 
...
For softwaredevelopment  the SCRUM methodology is used. With tasks rather than user stories,  tasks are sorted by which order we will execute them(most important first). This gives us the following backlog:\\
\\
...
Estimated effort 5\\
Task robot must have animations for “waking up” after boot.\\ 
Estimated effort 3 \\
Task robot must be able to complain about it’s “needs” (low power ext.).\\
Estimated effort 2 \\
...
\section{won'ts}
\begin{itemize}
\item Won’t be able to fly
\item Won’t be able to make underwater explorations
\item Won’t be able to be used as a vehicle     
\item Won’t be able to battle
\item Won't be able to move at great speed     
\item Won’t be able to retrieve the blocks himself
