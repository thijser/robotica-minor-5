...
A picture of the final construction can be found below. Detailed part drawings can be found in Appendix xxxxxxxx.
We used some plastic (POM) guiding rails to guide the rack is it’s being pulled back. POM is good for this use as it is a little bit wear resistant and has a low coefficient of friction on metal.

Figure 1: Launching mechanism
