...
\begin{wrapfigure}{l}{0.5\textwidth}
  ...
  \label{figure:boxbot}
\end{wrapfigure}
Next, the use cases of the chosen concept have been explained, these include asking the child for objects. Based on the use cases, the functional analysis has been done. Functions like being attractive to children, shooting balls and recognizing the objects have been identified.  These function lead to “must haves”, “should haves”, “could haves” and “won’t haves”; concrete design requirements. With the MosCow model and the functional analysis in mind, the morphological map gives a clear overview of design options.\\
 \\


Three initial designs have been made: the volcano bot, the box-bot and the truck teacher. These design can be seen in pictures in this summary.\\
 The volcano bot has already been described above, the box-bot lets children insert the objects in his hands and lifts them into his own shooting mechanism and the truck teacher does the same with a dump truck design. Furthermore, the choice of object form of balls size 50 mm has been chosen for safety reasons and ease of transportation in the robot itself. In addition, the game as described above has been chosen in favour of others, together with the game mode of dancing to music and manual control of robots driving system.
\begin{figure}[H]
\begin{center}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=12cm]{Images/Weight.png}
  \end{center}
  \caption{ }
  \label{figure:weigth}
\end{figure}
...
For these reasons, option 4 was selected: The NiMH battery.
...
\section{Part list}
From the mechanical and electronic designs a list of required parts can be constructed. These parts are summed up and are given a price indication. The result of this summation is found in Appendix \ref{appendix:parts}.
...
Prepare presentation and poster\\
\\
Week 9 (19 January) and week 10 (26 January) Finals week
...
\chapter{Parts}
\includepdf[pages={1,2,3}, landscape=true]{Images/BOM.pdf}
\includepdf[pages={1,2,3}]{Images/PartList.pdf}
